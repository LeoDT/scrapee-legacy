...
export function _xPathIndex(node: Node): number {
...
export function _xPathValue(node: Node, optimized: boolean): Step | null {
  let ownValue;
...
export function xPath(node: Node, optimized = false): string {
